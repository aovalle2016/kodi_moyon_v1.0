...
def SportsDevil():
    print "SportsDevil"
    url = "http://repo.adryanlist.org/plugin.video.SportsDevil-2016-03-06.zip"
...
SOURCES = [{"url": "https://raw.githubusercontent.com/adrianhn/adryanlist/master/list.xml", "fanart": "http://adrian.kodistream.info/fanart.jpg"}]
            ...
            try:
                ...
                if len(item('link')) >0:
                    ...
                    for i in item('p2p'):
                        if not i.string == None:
                            if 'sop://' in i.string:
                                sop = 'plugin://plugin.video.plexus/?mode=2url='+i.string +'&' + 'name='+name
                                url.append(sop)
                            else:
                                p2p='plugin://plugin.video.plexus/?mode=1&url='+i.string +'&' + 'name='+name
                                url.append(p2p)
